...
public class ClienteController {
	...
	public String findAll(Model model) {
		...
		//try {
			...
			model.addAttribute("keyClientes",clientes); // Ej. keyClientes , valor = Clientes

			return "listar-clientes";                   // Esto es el nombre del formulario EJ. listar-clientes.html o
										               // listar-clientes.jsp
...
//		try {
		...
		if (opcion == 1)
			return "add-clietes"; // Actializacion
		else
			return "del-clientes"; // Elimincion
